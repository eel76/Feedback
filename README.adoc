...
Feedback_Add (coding_guidelines RULES rules.json DIRECTORY "${CMAKE_SOURCE_DIR}")
----
...
Feedback_FindTargets (targets DIRECTORY "${CMAKE_SOURCE_DIR}" TYPES STATIC_LIBRARY MODULE_LIBRARY SHARED_LIBRARY)
...
Feedback_Add (CodingGuidelines RULES rules.json DIRECTORY "${CMAKE_SOURCE_DIR}")
----
