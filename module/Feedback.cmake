...
function (Feedback_ConfigureWorkflow name)
  ...
  cmake_parse_arguments (parameter "" "TYPE;CHECK;RESPONSE" "" ${ARGN})

  if (DEFINED parameter_UNPARSED_ARGUMENTS)
    message (FATAL_ERROR "Unparsed arguments: ${Feedback_UNPARSED_ARGUMENTS}")
  endif ()

  if (NOT DEFINED parameter_TYPE)
    message (FATAL_ERROR "No type given.")
  endif ()

  if (NOT DEFINED parameter_CHECK)
    set (parameter_CHECK "${FEEDBACK_WORKFLOW_${name}_CHECK_${parameter_TYPE}}")
    if (NOT parameter_CHECK)
      set (parameter_CHECK "all_files")
    endif ()
  endif ()

  if (NOT DEFINED parameter_RESPONSE)
    set (parameter_RESPONSE "${FEEDBACK_WORKFLOW_${name}_RESPONSE_${parameter_TYPE}}")
    if (NOT parameter_RESPONSE)
      set (parameter_RESPONSE "warning")
    endif ()
  endif ()

  list (APPEND "FEEDBACK_WORKFLOW_${name}_TYPES" "${parameter_TYPE}")
  ...
  set ("FEEDBACK_WORKFLOW_${name}_CHECK_${parameter_TYPE}" "${parameter_CHECK}" CACHE INTERNAL "")
  set ("FEEDBACK_WORKFLOW_${name}_RESPONSE_${parameter_TYPE}" "${parameter_RESPONSE}" CACHE INTERNAL "")
endfunction ()
